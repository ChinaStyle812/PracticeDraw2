...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap batlogo = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);
        Shader shader1 = new BitmapShader(batman, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader2 = new BitmapShader(batlogo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader comShader = new ComposeShader(shader1, shader2, PorterDuff.Mode.DST_IN);
